    ...
    for (int i = 0; i < 10; i++) {
      try {
        ...
        await Future.delayed(
            const Duration(milliseconds: 500)); // Rate limit delay
      } catch (e) {
        totalFailed++;
...
Future<void> createTestUser(
    String gender, String cityKey, Map<String, dynamic> city) async {
  final random = Random();
...
Map<String, dynamic> generateUserData(
    String gender, String cityKey, Map<String, dynamic> city, Random random) {
