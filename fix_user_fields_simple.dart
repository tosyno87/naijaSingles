...
/// Simple script to fix missing fields in user documents
...
bool _calculateProfileCompleteness(Map<String, dynamic> data) {
  ...
  if (data['lookingFor'] != null && data['lookingFor'].toString().isNotEmpty)
    score++;
  if (data['showGender'] != null && data['showGender'].toString().isNotEmpty)
    score++;
