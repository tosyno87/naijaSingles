...
exports.runAuthUserDeletedCleanup = runAuthUserDeletedCleanup;
 ...
 */
async function deleteSubcollection(db, userRef, subcollectionName) {
 ...
 */
async function deleteUserLikes(db, uid) {
 ...
 */
async function deleteUserMatches(db, uid) {
 ...
 */
async function deleteUserChatThreads(db, uid) {
 ...
 */
async function deleteUserLegacyChats(db, uid) {
 ...
 */
async function deleteUserSuperLikes(db, uid) {
 ...
 */
async function deleteRootCollectionByUserId(db, collectionName, fieldName, uid) {
    ...
    if (!snapshot.empty) {
        console.log(`Deleted ${snapshot.docs.length} ${collectionName} docs for user ${uid}`);
    }
}
/**
 * Updates the accountDeletions doc for this user to completed (written by client as pending before delete).
 */
async function writeAuditCompleted(db, uid) {
 ...
 */
async function runAuthUserDeletedCleanup(user) {
    const uid = user.uid;
 ...
 */
exports.onAuthUserDeleted = functions.auth.user().onDelete(runAuthUserDeletedCleanup);
//# sourceMappingURL=authCleanupHandlers.js.map