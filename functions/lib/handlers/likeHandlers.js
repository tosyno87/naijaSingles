...
class LikeHandlers {
    ...
    onSuperLikeCreated = (0, firestore_1.onDocumentCreated)('superLikes/{superLikeId}', async (event) => {
    ...
    onLikeCreated = (0, firestore_1.onDocumentCreated)('users/{userId}/LikedBy/{likeId}', async (event) => {
        const snap = event.data;
        if (!snap)
            return;
