...
class MessageHandlers {
    constructor() {
        this.onMessageSent = (0, firestore_1.onDocumentCreated)('chatThreads/{threadId}/messages/{messageId}', async (event) => {
            ...
            try {
                ...
                await this.logError('message_sent', error, { threadId, messageId, messageData });
            }
        });
