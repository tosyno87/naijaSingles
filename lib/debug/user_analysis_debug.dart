...
class UserAnalysisDebug {
  ...
  static Future<void> runCompleteAnalysis() async {
    ...
    debugPrint('   Other/Unknown: ${analytics.otherGenderCount + analytics.unknownGenderCount}');
    debugPrint('');
    ...
    debugPrint('   Gender Balance: ${(algorithmStatus.genderBalance * 100).toStringAsFixed(1)}% male');
    debugPrint('');
    ...
    if (analytics.incompleteUserIds.isNotEmpty) {
      debugPrint('⚠️ Incomplete Profiles (${analytics.incompleteUserIds.length}):');
    ...
    if (analytics.veryIncompleteUserIds.isNotEmpty) {
      debugPrint('🚨 Very Incomplete Profiles (${analytics.veryIncompleteUserIds.length}):');
    ...
    if (analytics.veryIncompleteUserIds.isNotEmpty) {
      ...
      debugPrint('   Found ${analytics.veryIncompleteUserIds.length} very incomplete profiles');
      debugPrint('   These profiles have < 40% completeness and can be safely deleted');
      debugPrint('   Run UserAnalysisDebug.cleanupIncompleteProfiles() to delete them');
      debugPrint('');
    }
  ...
  static Future<void> quickStatus() async {
    ...
    debugPrint('👥 Users: ${analytics.totalUsers} (M: ${analytics.maleCount}, F: ${analytics.femaleCount})');
    debugPrint('📋 Complete: ${analytics.completeProfiles}/${analytics.totalUsers}');
