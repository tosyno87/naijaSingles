...
class _TestDataManagementScreenState extends State<TestDataManagementScreen> {
  ...
  Future<void> _generateTestUsers({
    ...
    setState(() {
      _isLoading = true;
      _statusMessage = dryRun ? 'Previewing test users...' : 'Generating test users...';
    });
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Gender Distribution
            const Text('Gender Distribution:', style: TextStyle(fontWeight: FontWeight.bold)),
            ...
            // City Distribution
            const Text('City Distribution:', style: TextStyle(fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            ...cityStats.entries.map((entry) => Padding(
              padding: const EdgeInsets.symmetric(vertical: 2),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
              ...
              children: [
                Expanded(
                  child: ElevatedButton.icon(
                    onPressed: _isLoading ? null : () => _generateTestUsers(
                      city: 'all',
                      count: 20,
                      dryRun: true,
                    ),
