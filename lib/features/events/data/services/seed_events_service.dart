  ...
  List<EventModel> _getSampleAfrocentricEvents() {
    ...
    return [
      EventModel(
        ...
        description: 'Experience the best of Afrobeats music with top DJs and live performances. Dance the night away to the latest hits from Nigeria, Ghana, and across Africa.',
      ...
      EventModel(
        ...
        description: 'Discover contemporary African art, traditional crafts, and cultural artifacts. Meet local artists and learn about African heritage and traditions.',
      ...
      EventModel(
        ...
        description: 'Taste authentic Nigerian cuisine from different regions. Enjoy jollof rice, suya, pounded yam, and more delicious traditional dishes.',
      ...
      EventModel(
        ...
        description: 'Learn traditional and modern Afro-Caribbean dance moves. Suitable for all skill levels. Bring comfortable clothes and dancing shoes!',
