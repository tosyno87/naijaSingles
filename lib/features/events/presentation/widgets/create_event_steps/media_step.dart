...
class _MediaStepState extends State<MediaStep> {
  ...
  Future<void> _cropImage(int index) async {
    try {
      ...
      // For now, show a dialog explaining the crop preview
      showDialog(
        context: context,
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text(
                'The preview above shows how your image will appear in the event card.',
                style: GoogleFonts.montserrat(),
              ),
              const SizedBox(height: 16),
              Text(
      ...
      if (source == ImageSource.gallery) {
        ...
        if (image != null) {
          ...
          setState(() {
            ...
            // Add file path to event data for later upload
            widget.eventData.imageUrls.add(image.path);
          });
