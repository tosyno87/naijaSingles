...
class ModeSpecificFilteringService {
  ...
  static Query _applyDatingFilters(Query query, UserModel currentUser) {
    ...
    debugPrint('🔍 TEMPORARILY DISABLING lookingFor FILTER - field might not exist');
    // try {
    ...
    debugPrint('🔍 TEMPORARILY DISABLING hasDatingProfile FILTER FOR DEBUGGING');
  ...
  static Query _applyFriendshipFilters(Query query, UserModel currentUser) {
    ...
    query = query.where('lookingFor', whereIn: ['Friendship', 'Friends', 'Social']);
  ...
  static Query _applyNetworkingFilters(Query query, UserModel currentUser) {
    ...
    query = query.where('lookingFor', whereIn: ['Networking', 'Business', 'Professional']);
  ...
  static bool _validateDatingMatch(UserModel user) {
    ...
    final lookingForCheck = user.lookingFor == 'Dating' || user.lookingFor == 'Romance' || user.lookingFor == 'Relationship';
  ...
  static bool _validateFriendshipMatch(UserModel user) {
    ...
    return user.bio?.isNotEmpty == true &&
           (user.lookingFor == 'Friendship' || user.lookingFor == 'Friends' || user.lookingFor == 'Social');
  }
  ...
  static bool _validateNetworkingMatch(UserModel user) {
    ...
    return user.job_title?.isNotEmpty == true &&
           ...
           (user.lookingFor == 'Networking' || user.lookingFor == 'Business' || user.lookingFor == 'Professional');
  }
