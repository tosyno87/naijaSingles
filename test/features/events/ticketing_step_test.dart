...
void main() {
  group('TicketingStep', () {
    ...
    testWidgets('should display ticketing step with correct structure', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
      await tester.pumpAndSettle();

      expect(find.text('Event Pricing & Capacity'), findsOneWidget);
      expect(find.text('Set your event pricing and attendance limits'), findsOneWidget);
    });
    ...
    testWidgets('should display free/paid toggle options', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
      await tester.pumpAndSettle();
    ...
    testWidgets('should display currency selector for paid events', (WidgetTester tester) async {
    ...
    testWidgets('should display currency symbols correctly', (WidgetTester tester) async {
      // Set to paid event first
      eventData.isFree = false;
      ...
      expect(find.text('\$'), findsAtLeastNWidgets(1)); // Multiple $ symbols
      expect(find.text('£'), findsOneWidget);
      expect(find.text('€'), findsOneWidget);
    });

    testWidgets('should display price input for paid events', (WidgetTester tester) async {
      // Set to paid event first
      eventData.isFree = false;
      ...
      expect(find.byType(TextFormField), findsAtLeastNWidgets(2)); // Price + Capacity
    });

    testWidgets('should update price when input changes', (WidgetTester tester) async {
      // Set to paid event first
      eventData.isFree = false;
    ...
    testWidgets('should not display currency selector for free events', (WidgetTester tester) async {
    ...
    testWidgets('should handle decimal price input correctly', (WidgetTester tester) async {
      // Set to paid event first
      eventData.isFree = false;
